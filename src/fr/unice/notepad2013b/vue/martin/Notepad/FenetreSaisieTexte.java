...
private boolean			wasSaved;
   ...
   public FenetreSaisieTexte() {
      ...
      setSize((int)tailleEcran.getWidth()/2, (int)tailleEcran.getHeight()/2);
      setTitle ("Bloc Note V0_0_5");
