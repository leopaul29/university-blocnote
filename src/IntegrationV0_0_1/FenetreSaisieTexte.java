...
private boolean			wasSaved;
   ...
   public FenetreSaisieTexte() {
     ...
     // System.out.println(" :: "+itemsFichier.get("Police..."));
      ...
      //---- Installer l'ecouteur sur Ouvrir 
      MenuItem itemOuvrir = (MenuItem)itemsFichier.get("Ouvrir...");
      itemOuvrir.addActionListener(new EcouteurItemOuvrir(this));
      
      //--- Installer l'ecouteur sur Rechercher 
      MenuItem itemRechercher = (MenuItem)itemsEdition.get("Rechercher...");
      itemRechercher.addActionListener(new EcouteurItemRechercher(this));
      
      //-- Installer l'ecouteur sur Remplacer 
      // MenuItem itemRemplacer = (MenuItem)itemsEdition.get("Remplacer...");
      // itemRemplacer.addActionListener(new EcouteurItemRemplacer());
   
      //-- Installer l'ecouteur sur Enregistrer 
      // MenuItem itemEnregistrer = (MenuItem)itemsFichier.get("Enregistrer");
      // itemEnregistrer.addActionListener(new EcouteurItemEnregistrer());   
      
      
      // -- Installer l'ecouteur de l'item "Coller"
      MenuItem itemColler = (MenuItem)itemsEdition.get("Coller");
      itemColler.addActionListener(new EcouteurItemColler(this));
      
      // -- Installer l'ecouteur de l'item "Couper"
      MenuItem itemCouper = (MenuItem)itemsEdition.get("Couper");
      itemCouper.addActionListener(new EcouteurItemCouper(this));
      
      // -- Installer l'ecouteur de l'item "Copier"
      MenuItem itemCopier = (MenuItem)itemsEdition.get("Copier");
      itemCopier.addActionListener(new EcouteurItemCopier(this));
      
      // --- Installer l'ecouteur Date /heure
      MenuItem itemHeureDate = (MenuItem)itemsEdition.get("Heure/Date");
      itemHeureDate.addActionListener(new EcouteurItemDate(this));      
      
      // ---- Installer l'ecouteur Annuler 
      MenuItem itemAnnuler = (MenuItem)itemsEdition.get("Annuler");
      itemAnnuler.addActionListener(new EcouteurItemAnnuler(this));
      
      // ----- Installer l'ecouteur SelectAll
      MenuItem itemSelectAll = (MenuItem)itemsEdition.get("Selectionner tout");
      itemSelectAll.addActionListener(new EcouteurItemSelectAll(this));
      
      
      // ----- Installer l'ecouteur Supprimer
      MenuItem itemSupprimer = (MenuItem)itemsEdition.get("Supprimer");
