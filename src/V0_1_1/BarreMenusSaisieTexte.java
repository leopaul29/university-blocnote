/**
 *
 * La classe BarreMenusSaisieTexte fournit un ensemble de services destinés à créer une barre 
 * de menu dans l'application FenetreSaisieTexte
 *
...
/**
 *
 * La méthode BarreMenusSaisieTexte crée une barre de menu en chargeant plusieurs menus
 * composés d'item dans l'application FenetreSaisieTexte.
 * 
**/
  ...
  /**
 *
 * La méthode main crée la barre de menu pour la mettre sur le cadre d'une fenetre.
 * 
**/
   // ---                                                         Methode main
